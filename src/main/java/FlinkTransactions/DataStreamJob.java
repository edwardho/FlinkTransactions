...
public class DataStreamJob {
	...
	public static void main(String[] args) throws Exception {
		...
		String topic = "financialTransactions";
		...
		// create Postgresql transactions table sink
		...
		// insert into Postgresql transactions table sink
		transactionDataStream.addSink(JdbcSink.sink(
		...
		// insert into Postgresql sales by category table sink
		...
		// insert into Postgresql sales per day table sink
		transactionDataStream.map(
						transaction -> {
							Date transactionDate = new Date(System.currentTimeMillis());
							double totalSales = transaction.getTotalAmount();
		...
		// insert into Postgresql sales per month table sink
		transactionDataStream.map(
						transaction -> {
							Date transactionDate = new Date(System.currentTimeMillis());
		...
		env.execute("Flink Transactions Realtime Streaming");
	}
}
